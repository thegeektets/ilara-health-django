"""
Django settings for ilara_pharmacy project.
...
ALLOWED_HOSTS = ['griffinmuteti.pythonanywhere.com']
...
ROOT_URLCONF = 'ilara_pharmacy.urls'
...
WSGI_APPLICATION = 'ilara_pharmacy.wsgi.application'
